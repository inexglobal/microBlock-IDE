...
`) + "(" + c + ", " + d + ", " + a + ")", Order$$module$build$src$generators$javascript$javascript_generator.FUNCTION_CALL]
      ...
      , lists_create_with$$module$build$src$generators$javascript$lists = function(a, b) {
        ...
        for (let d = 0; d < a.itemCount_; d++)
            c[d] = b.valueToCode(a, "ADD" + d, Order$$module$build$src$generators$javascript$javascript_generator.NONE) || "null";
...
`)
      ...
      , lists_getIndex$$module$build$src$generators$javascript$lists = function(a, b) {
        ...
        case "FIRST":
            if ("GET" === c)
                return [e + "[0]", Order$$module$build$src$generators$javascript$javascript_generator.MEMBER];
            if ("GET_REMOVE" === c)
                return [e + ".shift()", Order$$module$build$src$generators$javascript$javascript_generator.MEMBER];
            if ("REMOVE" === c)
                return e + ".shift();\n";
            break;
        case "LAST":
            if ("GET" === c)
                return [e + ".slice(-1)[0]", Order$$module$build$src$generators$javascript$javascript_generator.MEMBER];
            if ("GET_REMOVE" === c)
                return [e + ".pop()", Order$$module$build$src$generators$javascript$javascript_generator.MEMBER];
            if ("REMOVE" === c)
                return e + ".pop();\n";
            break;
        case "FROM_START":
            ...
            if ("GET" === c)
                return [e + "[" + a + "]", Order$$module$build$src$generators$javascript$javascript_generator.MEMBER];
            if ("GET_REMOVE" === c)
                return [e + ".splice(" + a + ", 1)[0]", Order$$module$build$src$generators$javascript$javascript_generator.FUNCTION_CALL];
            if ("REMOVE" === c)
                return e + ".splice(" + a + ", 1);\n";
            break;
        case "FROM_END":
            ...
            if ("GET" === c)
                return [e + ".slice(" + a + ")[0]", Order$$module$build$src$generators$javascript$javascript_generator.FUNCTION_CALL];
            if ("GET_REMOVE" === c)
                return [e + ".splice(" + a + ", 1)[0]", Order$$module$build$src$generators$javascript$javascript_generator.FUNCTION_CALL];
            if ("REMOVE" === c)
                return e + ".splice(" + a + ", 1);";
...
`) + "(" + e + ", " + ("GET" !== c) + ")";
            if ("GET" === c || "GET_REMOVE" === c)
                return [e, Order$$module$build$src$generators$javascript$javascript_generator.FUNCTION_CALL];
            if ("REMOVE" === c)
                return e + ";\n"
        }
      ...
      , lists_setIndex$$module$build$src$generators$javascript$lists = function(a, b) {
        ...
        case "FROM_END":
            ...
            if ("INSERT" === e)
                return f + (d + ".splice(" + d + ".length - " + a + ", 0, " + g + ");\n");
            break;
        case "RANDOM":
            a = c();
  ...
  return function(a, b) { return compare(a, b) * direction; };
      ...
      , controls_if$$module$build$src$generators$javascript$logic = function(a, b) {
        ...
        do {
            ...
            d += (0 < c ? " else " : "") + "if (" + e + ") {\n" + f + "}";
            c++
        } while (a.getInput("IF" + c));if (a.getInput("ELSE") || b.STATEMENT_SUFFIX)
      ...
      , controls_repeat_ext$$module$build$src$generators$javascript$loops = function(a, b) {
        ...
        let f = c;
        c.match(/^\w+$/) || $.isNumber$$module$build$src$core$utils$string(c) || (f = b.nameDB_.getDistinctName("repeat_end", $.NameType$$module$build$src$core$names.VARIABLE),
        a += "var " + f + " = " + c + ";\n");
      ...
      , controls_for$$module$build$src$generators$javascript$loops = function(a, b) {
        var c = b.nameDB_.getName(a.getFieldValue("VAR"), $.NameType$$module$build$src$core$names.VARIABLE)
        ...
        if ($.isNumber$$module$build$src$core$utils$string(d) && $.isNumber$$module$build$src$core$utils$string(e) && $.isNumber$$module$build$src$core$utils$string(f))
            ...
            a = "";
            let h = d;
            d.match(/^\w+$/) || $.isNumber$$module$build$src$core$utils$string(d) || (h = b.nameDB_.getDistinctName(c + "_start", $.NameType$$module$build$src$core$names.VARIABLE),
            a += "var " + h + " = " + d + ";\n");
            d = e;
            e.match(/^\w+$/) || $.isNumber$$module$build$src$core$utils$string(e) || (d = b.nameDB_.getDistinctName(c + "_end", $.NameType$$module$build$src$core$names.VARIABLE),
            a += "var " + d + " = " + e + ";\n");
      ...
      , controls_forEach$$module$build$src$generators$javascript$loops = function(a, b) {
        ...
        a = "";
        let f = d;
        d.match(/^\w+$/) || (f = b.nameDB_.getDistinctName(c + "_list", $.NameType$$module$build$src$core$names.VARIABLE),
        a += "var " + f + " = " + d + ";\n");
      ...
      , math_single$$module$build$src$generators$javascript$math = function(a, b) {
        ...
        let d;
        if ("NEG" === c)
            return a = b.valueToCode(a, "NUM", Order$$module$build$src$generators$javascript$javascript_generator.UNARY_NEGATION) || "0",
            "-" === a[0] && (a = " " + a),
            ["-" + a, Order$$module$build$src$generators$javascript$javascript_generator.UNARY_NEGATION];
...
`) + "(" + c + ")" : "DIVISIBLE_BY" === d ? (a = b.valueToCode(a, "DIVISOR", Order$$module$build$src$generators$javascript$javascript_generator.MODULUS) || "0",
        a = c + " % " + a + " === 0") : a = c + e;
        return [a, g]
    }
      , math_change$$module$build$src$generators$javascript$math = function(a, b) {
        ...
        a = b.nameDB_.getName(a.getFieldValue("VAR"), $.NameType$$module$build$src$core$names.VARIABLE);
...
`) + "(" + c + ", " + a + ")", Order$$module$build$src$generators$javascript$javascript_generator.FUNCTION_CALL]
      ...
      , procedures_defreturn$$module$build$src$generators$javascript$procedures = function(a, b) {
        ...
        for (let n = 0; n < l.length; n++)
            k[n] = b.nameDB_.getName(l[n], $.NameType$$module$build$src$core$names.VARIABLE);
        d = "function " + c + "(" + k.join(", ") + ") {\n" + d + e + f + h + g + "}";
        d = b.scrub_(a, d);
        b.definitions_["%" + c] = d;
        return null
      ...
      , procedures_callreturn$$module$build$src$generators$javascript$procedures = function(a, b) {
        ...
        for (let f = 0; f < e.length; f++)
            d[f] = b.valueToCode(a, "ARG" + f, Order$$module$build$src$generators$javascript$javascript_generator.NONE) || "null";
      ...
      , procedures_ifreturn$$module$build$src$generators$javascript$procedures = function(a, b) {
        ...
        a.hasReturnValue_ ? (a = b.valueToCode(a, "VALUE", Order$$module$build$src$generators$javascript$javascript_generator.NONE) || "null",
        c += b.INDENT + "return " + a + ";\n") : c += b.INDENT + "return;\n";
        return c + "}\n"
    }
      ...
      , text_join$$module$build$src$generators$javascript$text = function(a, b) {
        ...
        case 0:
            return ["''", Order$$module$build$src$generators$javascript$javascript_generator.ATOMIC];
        case 1:
            return a = b.valueToCode(a, "ADD0", Order$$module$build$src$generators$javascript$javascript_generator.NONE) || "''",
        ...
        default:
            ...
            for (let d = 0; d < a.itemCount_; d++)
                c[d] = b.valueToCode(a, "ADD" + d, Order$$module$build$src$generators$javascript$javascript_generator.NONE) || "''";
      ...
      , text_charAt$$module$build$src$generators$javascript$text = function(a, b) {
        ...
        case "FROM_START":
            return a = b.getAdjusted(a, "AT"),
            [d + ".charAt(" + a + ")", Order$$module$build$src$generators$javascript$javascript_generator.FUNCTION_CALL];
        case "FROM_END":
            return a = b.getAdjusted(a, "AT", 1, !0),
            [d + ".slice(" + a + ").charAt(0)", Order$$module$build$src$generators$javascript$javascript_generator.FUNCTION_CALL];
        case "RANDOM":
...
`) + "(" + d + ")", Order$$module$build$src$generators$javascript$javascript_generator.FUNCTION_CALL]
      ...
      , text_getSubstring$$module$build$src$generators$javascript$text = function(a, b) {
        ...
        if ("FIRST" === c && "LAST" === d)
            return [f, Order$$module$build$src$generators$javascript$javascript_generator.NONE];
        if (f.match(/^'?\w+'?$/) || e) {
            switch (c) {
            case "FROM_START":
...
`) + "(" + c + ", " + d + ", " + a + ")", Order$$module$build$src$generators$javascript$javascript_generator.FUNCTION_CALL]
      ...
      , variables_get$$module$build$src$generators$javascript$variables = function(a, b) {
        return [b.nameDB_.getName(a.getFieldValue("VAR"), $.NameType$$module$build$src$core$names.VARIABLE), Order$$module$build$src$generators$javascript$javascript_generator.ATOMIC]
    }
      , variables_set$$module$build$src$generators$javascript$variables = function(a, b) {
        ...
        return b.nameDB_.getName(a.getFieldValue("VAR"), $.NameType$$module$build$src$core$names.VARIABLE) + " = " + c + ";\n"
    }
      ...
      , JavascriptGenerator$$module$build$src$generators$javascript$javascript_generator = class extends $.CodeGenerator$$module$build$src$core$generator {
        constructor(a) {
            ...
            for (const b in Order$$module$build$src$generators$javascript$javascript_generator)
                this["ORDER_" + b] = Order$$module$build$src$generators$javascript$javascript_generator[b];
        ...
        init(a) {
            ...
            // b.length && (this.definitions_.variables = "int " + b.join(", ") + ";");
            
            // Declare all of the variables. (Modify for support C/C++)
            /*console.log("type db222", Blockly.JavaScript.dbNameType);
            if (b.length) {
                console.log("type db", Blockly.JavaScript.dbNameType);
        ...
        scrub_(a, b, c) {
            ...
            if (!a.outputConnection || !a.outputConnection.targetConnection) {
                ...
                e && (e = $.wrap$$module$build$src$core$utils$string(e, this.COMMENT_WRAP - 3),
        ...
        getAdjusted(a, b, c, d, e) {
            ...
            $.isNumber$$module$build$src$core$utils$string(a) ? (a = Number(a) + c,
            d && (a = -a)) : (0 < c ? a = a + " + " + c : 0 > c && (a = a + " - " + -c),
            d && (a = c ? "-(" + a + ")" : "-" + a),
            g = Math.floor(g),
            e = Math.floor(e),
            g && e >= g && (a = "(" + a + ")"));
